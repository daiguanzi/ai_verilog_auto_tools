...
HD_PWD='C:/Users/12430/Desktop/ai_verilog_auto_tools/outputs/dft8_axi/vivado_synth/_dft8_axi_top/dft8_axi_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dft8_axi_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dft8_axi_top.tcl -notrace
