...
HD_PWD='C:/Users/12430/Desktop/ai_verilog_auto_tools/outputs/bram_acc/vivado_synth/_bram_acc/bram_acc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_acc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bram_acc.tcl -notrace
