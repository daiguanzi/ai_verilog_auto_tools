...
HD_PWD='C:/Users/12430/Desktop/ai_verilog_auto_tools/outputs/bram_acc/vivado_synth/_bram_acc/bram_acc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_acc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_acc.tcl
